...
This Jupyter Notebook performs Exploratory Data Analysis (EDA) on the Superstore dataset using Python. It prepares the data, calculates key business metrics, and generates visualizations to uncover sales, profit, customer, regional, and product insights that support SQL analysis and Power BI dashboard creation.

## Objectives

* Load and inspect the Superstore dataset.
* Validate data quality by checking missing values and duplicates.
...
The processed data and analytical insights from this notebook are used to support:
